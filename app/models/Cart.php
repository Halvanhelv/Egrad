...
class Cart extends AppModel {
    public function recToCart($product,$qty)
    {
        ...
        if(isset($_SESSION['cart'][$ID])){
            $_SESSION['cart.qty'] = isset($_SESSION['cart.qty']) ? $_SESSION['cart.qty'] -  $_SESSION['cart'][$ID]['qty'] : $qty;
            $_SESSION['cart.sum'] = isset($_SESSION['cart.sum']) ? $_SESSION['cart.sum'] - $_SESSION['cart'][$ID]['qty']  * ($price * $_SESSION['cart.currency']['value']) : $qty * ($price * $_SESSION['cart.currency']['value']);
